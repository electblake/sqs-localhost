...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SQSLocal; });
...
class SQSLocal {
    constructor(options) {
        this.installPath = path__WEBPACK_IMPORTED_MODULE_4__["join"](os__WEBPACK_IMPORTED_MODULE_0__["tmpdir"](), 'sqs-local');
        this.version = '0.14.6';
    ...
    async launch(options) {
        ...
        const child = Object(child_process__WEBPACK_IMPORTED_MODULE_2__["spawn"])('java', args, {
    ...
    remove() {
        fs__WEBPACK_IMPORTED_MODULE_1__["unlinkSync"](this.installedJarPath);
    }
    get installedJarPath() {
        return path__WEBPACK_IMPORTED_MODULE_4__["join"](this.installPath, this.jarname);
    }
    async install(options) {
        ...
        const verbose = this.verbose;
        try {
            if (fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"](this.installedJarPath)) {
        ...
        if (!fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"](this.installPath))
            fs__WEBPACK_IMPORTED_MODULE_1__["mkdirSync"](this.installPath);
        const dest = fs__WEBPACK_IMPORTED_MODULE_1__["createWriteStream"](this.installedJarPath);
        dest.on('finish', () => dest.close());
        if (fs__WEBPACK_IMPORTED_MODULE_1__["existsSync"](this.downloadUrl)) {
            debug('Installing from local file:', this.downloadUrl);
            const downloadUrl = this.downloadUrl;
            return new Promise((resolve, reject) => {
                const res = fs__WEBPACK_IMPORTED_MODULE_1__["createReadStream"](downloadUrl)
                    .on('end', function () {
                    resolve(true);
                })
                    .on('error', function (err) {
            ...
            return new Promise((resolve, reject) => {
                https__WEBPACK_IMPORTED_MODULE_3__["get"](downloadUrl, function (res) {
